...
The application is built using Streamlit to provide an interactive user interface for entering building characteristics and receiving real-time predictions.

Objectives

Analyze structural and geological features that influence earthquake damage.

Predict earthquake vulnerability of buildings using machine learning.

Visualize the impact of building attributes through a user-friendly interface.

Key Features

Predicts whether a building is safe or likely to be damaged in an earthquake.

Uses multiple structural features such as:
...
Easy-to-use input fields for building specifications.

Real-time classification using a pre-trained machine learning model.
...
Streamlit – Web app interface for interaction
